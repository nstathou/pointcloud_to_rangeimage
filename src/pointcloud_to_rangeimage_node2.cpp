...
public:
    ...
    it_(nh_)
  {
    ...
    drsv_.reset(new RangeImageReconfServer(ros::NodeHandle("pointcloud_to_rangeimage_dynreconf2")));
    ...
    ros::NodeHandle nh;
    sub_ = nh.subscribe<PointCloud>("/cloud_registered", 1, &RangeImageConverter::callback, this);
...
{
  ros::init(argc, argv, "pointcloud_to_rangeimage_2");
